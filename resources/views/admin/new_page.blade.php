            ...
            <div class="col-md-12">
                <div class="portlet box grey-cascade">
                    <div class="portlet-title">
                        <div class="caption"> <i class="fa fa-pencil-square-o" style="line-height: 10px;font-size: 20px;"></i>New Page </div>
                        <div class="tools">
                    ...
                    <div class="portlet-body">
                        <div class="table-toolbar"> @if(Session::has('success'))
                            ...
                            <form role="form" method="POST" action="{{ url('/dashboard/pages/new') }}"> {!! csrf_field() !!}
                                <div style="margin-bottom: 30px;" class="col-md-9">
                                    <input name="page_title" class="form-control" placeholder="Page title" type="text"> <span class="help-block">
EX: Privacy Policy. </span> </div>
                                <div style="margin-bottom: 30px;" class="col-md-9">
                                    <input name="page_url" class="form-control" placeholder="Page URL" type="text"> <span class="help-block">
