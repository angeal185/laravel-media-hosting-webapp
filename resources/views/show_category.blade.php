@extends('layouts.app')
@section('title') {{ $name }} | {{$setting->website_name}}
@endsection
@section('content')
<div class="container">
    <div class="row">
        <div class="col-xs-12 col-sm-6 col-md-8 home-content"> @if ($ads->home_top_ad_code)
            ...
            <center>
                <div class="row" style="margin-bottom: 50px"> @if (count($media) === 0)
                    <div class="alert alert-info" role="alert" style="width: 95%;"> <b>Oops!</b> It looks like no media in this category. </div> @else
