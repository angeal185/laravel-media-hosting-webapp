@extends('layouts.app')
@section('title')
Search For: {{$input}} | {{$setting->website_name}}
@endsection
@section('content')
<div class="container">
    <div class="row">
        <div class="col-xs-12 col-sm-6 col-md-8 home-content"> @if ($ads->home_top_ad_code)
            ...
            <center>
                <div class="row" style="margin-bottom: 50px"> @if (count($searched_media) === 0)
                    <div class="alert alert-info" role="alert" style="width: 95%;"> <b>Oops!</b> Try again. It looks like no media much your search. </div> @else
                    <div id="boxes"> @foreach ($searched_media as $m)
                    ...
                    <div class="col-span-12">
                        <div style="display: none;" class="paginate text-center"> {{$searched_media->links()}} </div>
                    </div> @endif </div>
            </center>
        </div>
        <div class="col-xs-6 col-md-4 sidebar">
            ...
            <div class="social_icons">
                <ul style="margin-right: 35px" class="social-links clearfix"> @if ($setting->facebook_page_id)
                    ...
                    </li> @endif @if($setting->twitter_page_id)
                    ...
                    </li> @endif @if($setting->google_page_id)
